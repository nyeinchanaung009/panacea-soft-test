...
<div class="w-full border border-gray-200 rounded-lg bg-gray-200/50 dark:bg-slate-700 dark:border-gray-600">
...
<div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
    ...
    <div id="wysiwyg-example" class="block w-full py-2 text-sm text-gray-800 bg-gray-200/60 dark:bg-white border-0 focus:ring-0 dark:text-white dark:placeholder-gray-400"></div>
</div>
</div>
